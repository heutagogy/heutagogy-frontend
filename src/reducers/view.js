...
const getNextNotificationMessage = data =>
  Immutable.fromJS({
...
export default (state = initialState, action) => {
  if (action.error) {
    const nextNotification = state
      .get('notifications')
      .unshift(getNextNotificationMessage(action))
    ...
    const nextNotification = state
      .get('notifications')
      .unshift(getNextNotificationMessage(action.notification))

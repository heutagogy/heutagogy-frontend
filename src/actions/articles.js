...
import {
  REMEMBER_ARTICLES_VIEW_STATE,
  UPDATE_ARTICLE_VIEW_STATE,
  DELETE_ARTICLE_VIEW_STATE
...
export const rememberArticles = ({ articles }) => dispatch =>
  dispatch(postRememberArticles({ articles }))
...
export const deleteArticle = articleId => dispatch =>
  dispatch(deleteDeleteArticle(articleId))
